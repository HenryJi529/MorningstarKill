...
<template>
    <div @click="handlePrint" class="absolute right-0 top-0 p-10 text-6xl" v-if="!isMobile">
        <font-awesome-icon :icon="['fas', 'download']" class="cursor-pointer"/>
    </div>
    <div ref="page" id="page" class="box-border px-8 py-12 mx-auto font-family-code" data-theme="light">
        <div class="flex justify-between items-end gap-10">
            <div class="flex-1">
                <div class="flex flex-col">
                    <div class="flex items-center px-8 space-x-32">
                        <div class="text-5xl font-family-kai">
                            <span>
                                吉普
                            </span>
                        </div>
                        <div class="text-2xl text-gray-700 font-family-song">
                            求职意向: Java后端开发
                        </div>
                    </div>
                    <div class="pt-4 px-8 grid grid-cols-2 gap-y-2 gap-x-0 text-lg">
                        ...
                        <div>
                            <span>联系电话: </span>
                            <span v-if="userStore.isAdmin">19850052801</span>
                            <span v-else class="text-gray-600">***********</span>
                        </div>
                        <div>
                            <span>电子邮箱: </span>
                            <a v-if="userStore.isAdmin" href="mailto:jeep.jipu@outlook.com">jeep.jipu@outlook.com</a>
            ...
            <div class="w-[8rem]">
                <img src="/media/resume/img/证件照.JPG?url" alt="证件照" class="w-full">
            </div>
        </div>
                ...
                <div class="pl-8">
                    <div><span class="font-bold">主要工作: </span>
                        <ol class="ml-8 list-disc">
                            <li>
                                前端: 采用Vue3构建SPA，并结合TailwindCSS和DaisyUI美化页面样式
                            </li>
                            <li>
                                后端: 采用Django与DRF，构建RESTful API
                            </li>
                            <li>
                                运维: 使用Docker与Supervisor将项目部署于腾讯云，并通过GithubAction实现持续集成
                            </li>
                            <li>
                                算法: 实现了基于Transformer的图像识别模型，应用于图像识别子应用
                            </li>
                        </ol>
                    </div>
                    <div>
                        <span class="font-bold">项目成果: </span>
                        开发并部署了一系列Web应用程序，包括技术博客、图像识别工具、聚合阅读源工具以及数学公式转换器。
                    </div>
                </div>
            </div>
            <div class="item">
                ...
                <div class="pl-8">
                    ...
                    <div>
                        <span class="font-bold">项目成果: </span>
                        该算法在保持了接近朴素算法高准确度的同时，还实现了较低的复杂度，且具有良好的泛化能力和实用性。
                    </div>
                </div>
            </div>
            <div class="item">
                ...
                <div class="pl-8">
                    <div><span class="font-bold">主要工作: </span>
                        <ol class="ml-8 list-disc">
                            ...
                            <li>将新Bucket的创建转换为Github仓库的创建，平台数据库中只需存储PAT和BucketId与RepoName映射表</li>
                            <li>将图片的上传与更新转换为仓库中commit的提交，响应的文件路径通过jsDelivr封装，无缝提供CDN支持</li>
                            <li>Web端加载仓库的文件结构缓存，便于用户的可视化操作</li>
                            <li>Java SDK提供核心的认证、建桶、上传、更新、删除功能</li>
                        </ol>
                    </div>
                    <div>
                        <span class="font-bold">项目成果: </span>
                        实现了图床服务Web端的搭建，并提供了相关的Java SDK，可以为用户提供简便、专业且零成本的图床服务
                    </div>
                </div>
            </div>
        </div>
        ...
        <ul class="detail list-disc ml-12">
            <li>
